...
CL = 2.99792458e10
RHO_UNIT =  6.17244*1e17 * 1.85e-08 #/ 1.85e-08 factor is used to normalize density such that maximum density is unity; it is important to note that this RHO_UNIT is not applied before primitives are writen to prim.h5 #c^6 /(G^3 * MSun^2) in cgs (2.99792458*10^10)^6/((6.6742*10^-8)^3*(1.989*10^33)^2) TODO: get this normalization factor runtime
T_UNIT = 1.e-3
